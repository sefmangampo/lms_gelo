...
ActiveRecord::Schema.define(version: 2021_09_15_025622) do
  ...
  create_table "appointments", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "text"
  ...
  create_table "employee_statuses", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.boolean "active"
    t.string "description"
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "employment_statuses", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.string "name"
    t.boolean "active"
    t.string "description"
    t.datetime "created_at", precision: 6, null: false
  ...
  create_table "import_leave_buffers", charset: "utf8mb4", collation: "utf8mb4_unicode_ci", force: :cascade do |t|
    t.integer "empid"
    t.string "employeename"
