...
--
-- Table structure for table `accrual_adjustments`
--

DROP TABLE IF EXISTS `accrual_adjustments`;
...
--
-- Dumping data for table `accrual_adjustments`
--

LOCK TABLES `accrual_adjustments` WRITE;
/*!40000 ALTER TABLE `accrual_adjustments` DISABLE KEYS */;
/*!40000 ALTER TABLE `accrual_adjustments` ENABLE KEYS */;
UNLOCK TABLES;
